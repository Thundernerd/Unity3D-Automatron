...
#pragma warning disable 0649
	...
	class CanvasRendererGetMaterial7 : Automation {
		...
		public override IEnumerator Execute() {
			Result = Instance.GetMaterial(index);
			yield break;
		}
	...
	[Automation( "Canvas Renderer/Set Alpha Texture" )]
	class CanvasRendererSetAlphaTexture11 : Automation {

		public UnityEngine.CanvasRenderer Instance;
		public UnityEngine.Texture texture;

		public override IEnumerator Execute() {
			Instance.SetAlphaTexture(texture);
			yield break;
		}
	...
	class CanvasRendererSetMesh12 : Automation {
	...
	class CanvasRendererClear13 : Automation {
